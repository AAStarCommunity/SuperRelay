...
//! 
//! 这个测试验证 Gateway 是否能够成功处理 UserOperation 并将其转发给 Pool 组件
...
#[tokio::test]
async fn test_gateway_pool_integration() {
...
/// 测试 Builder API 方法
#[tokio::test]
async fn test_builder_api_methods() {
...
#[tokio::main]
async fn main() {
    println!("🚀 开始 H2.1 Gateway-Pool-Builder 集成测试");
    
    test_gateway_pool_integration().await;
    test_builder_api_methods().await;
    test_error_handling().await;
    
    println!("🎉 所有 H2.1 集成测试通过！");
    println!();
    println!("📋 完成的功能:");
    println!("  ✅ Gateway 集成 LocalPoolHandle");
    println!("  ✅ Gateway 集成 LocalBuilderHandle (架构层面)");
    println!("  ✅ 添加 BuilderError 错误类型");
    println!("  ✅ 实现基本的 Builder API 方法");
    println!("  ✅ UserOperation 从 Gateway 到 Pool 的流转");
    println!();
    println!("🔄 下一步 TODO:");
    println!("  📌 完善 LocalBuilderBuilder 依赖注入");
    println!("  📌 实现真正的 Builder 实例创建");
    println!("  📌 完善 bundle_by_hash 等高级方法");
}